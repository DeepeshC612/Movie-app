...
export const metadata: Metadata = {
  title: "Movie App",
  description: "Movie Database Management Application",
};
        ...
        <AuthProvider>
          <ToastProvider>
            <div className="min-h-screen relative overflow-hidden" 
                 style={{ backgroundColor: '#093545', fontFamily: 'Montserrat, sans-serif' }}>
              
              {/* Wave overlays */}
              <div className="absolute bottom-0 left-0 w-full z-10">
                <svg width="1440" height="111" viewBox="0 0 1440 111" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
